...
public class Window_test {
    ...
    public Window_test(int width, int height, String title) {
        this.width = width;
        this.height = height;
        this.title = title;
    }
    ...
    public void calculateMouseChange() {
    	...
    	mouseX = Input_test.getMouseX();
    	mouseY = Input_test.getMouseY();
